...
class ListingController extends Controller
{
    ...
    public function getProducts()
    {
        ...
        ->groupBy('listings.id', 'listings.title', 'users.name', 'users.email', 'users.location','listings.description','listings.price','listings.shipping_options','listings.image', 'users.profile_picture')
        ->get();
