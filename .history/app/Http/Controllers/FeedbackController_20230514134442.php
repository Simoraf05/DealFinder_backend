...
class FeedbackController extends Controller
{
    ...
    public function getComments (Request $request)
    {
        ...
        ->join('users', 'users.id', '=', 'feedback.author_id')
        ->select('feedback.id', 'feedback.comment', 'feedback.created_at', 'feedback.listings_id', 'users.name', 'users.profile_picture')
        ->where('listings_id', '=', 49)
        ->get();
