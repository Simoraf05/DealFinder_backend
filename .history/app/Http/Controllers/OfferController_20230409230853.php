...
class OfferController extends Controller
{
    ...
    {
        $productPrice = DB::table('listings')
        ->join('offers','on','offers.listing_id')
        ->where('offers.listing_id','=',$request->listing_id)
        ->select('listings.price as priceProduct,listings.title ,offers.price as priceOffer')
        ->get();
        ...
        $offer->save();
        return response()->json(['message'=>'offer added successfully','offer'=>$offer,'price'=>$productPrice]);
    }
