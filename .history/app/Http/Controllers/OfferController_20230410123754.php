...
class OfferController extends Controller
{
    ...
    public function getMyOffers(Request $request)
    {
        ...
        ->select('u.name as seller_name','l.id a', 'l.image as product_image','l.title', 'l.price', 'o.id as offer_id','o.price as offer_price', 'o.status as offer_status', 'b.name as buyer_name', 'b.email as buyer_email', 'b.profile_picture')
        ->get();
