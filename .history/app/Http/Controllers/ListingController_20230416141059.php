...
class ListingController extends Controller
{
    ...
    public function getProducts()
    {
        ...
        ->select('listings.*', 'users.name', 'users.email', 'users.location', 'users.profile_picture', DB::raw('GROUP_CONCAT(offers.price) AS offer_prices'))
        ...
        'users.location','listings.description','listings.price','listings.shipping_options','listings.image','listings.category','listings.status','listings.seller_id','listings.created_at', 'users.profile_picture')
        ->get();
