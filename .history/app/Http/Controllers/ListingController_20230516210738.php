...
class ListingController extends Controller
{
    ...
    public function productsInCategory(Request $request)
    {
        $productCount = DB::table('listings')
            ->select(DB::raw('COUNT(*) AS product_count'), 'listings.category')
            ->where('listings.category', '=', $request->category)
            ->get();
        $productCount = $productCount->first()->product_count;
        $category = $productCount->first()->$request->category;
