...
class ListingController extends Controller
{
    ...
    public function getProducts()
    {
        ...
        'users.location','listings.description','listings.price','listings.shipping_options','listings.image','listings.category','listings.status','listings.seller_id','', 'users.profile_picture')
        ->get();
