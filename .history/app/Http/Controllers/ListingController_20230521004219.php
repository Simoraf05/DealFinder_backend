...
class ListingController extends Controller
{
    ...
    public function getProducts()
    {
        ...
        $products = DB::table('listings')
            ->selectRaw('listings.*, users.name, users.email, users.location, users.profile_picture, CONCAT("[", GROUP_CONCAT(JSON_OBJECT(offers.buyer_id, offers.price)), "]") AS offer_prices,CONCAT("[", GROUP_CONCAT(JSON_OBJECT(product_images.path)), "]") AS offer_prices')
