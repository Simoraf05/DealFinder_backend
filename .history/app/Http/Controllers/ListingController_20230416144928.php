...
class ListingController extends Controller
{
    ...
    public function getProducts()
    {
        ...
        ->selectRaw('listings.*, users.name, users.email, users.location, users.profile_picture, DB::raw('JSON_ARRAYAGG(JSON_OBJECT("offers_price", offers.price)) as offer_prices')
        ')
