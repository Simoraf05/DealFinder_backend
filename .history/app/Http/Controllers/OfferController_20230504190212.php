...
class OfferController extends Controller
{
    ...
    public function offer_detail(Request $request)
    {
        ...
        ->select('listings.id as product_id','offers.price as offer_price','offers.status','users.name as buyer_name','users.email as buyer_email')
        ->get();
        return response()->json(['offer_detaim'=>$statusUpdate]);
