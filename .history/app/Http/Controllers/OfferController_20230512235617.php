...
class OfferController extends Controller
{
    ...
    public function getMyOffers(Request $request)
    {
        ...
        ->select('offers.id as offer_id', 'offers.price as offer_price', 'offers.status as offer_status', 'listings.title', 'listings.image as product_image', 'listings.price', 'listings.id as idP')
