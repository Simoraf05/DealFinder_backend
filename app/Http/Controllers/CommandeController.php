...
class CommandeController extends Controller
{
    public function getCommande(Request $request)
    {
        ...
        ->select('u.name as seller_name','l.id as idP',
         'o.status','l.image as product_image','l.title', 'l.price',
         'o.id as offer_id','o.price as offer_price',
         'o.status as offer_status', 's.name as buyer_name',
         's.email as seller_email','s.id as seller_id', 'u.profile_picture')
        ->get();
